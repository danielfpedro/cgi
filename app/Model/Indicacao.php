 ...
 */
	public $belongsTo = array(
		'StatusIndicacao' => array(
			'className' => 'StatusIndicacao',
			'foreignKey' => 'status_indicacao_id',
			'conditions' => '',
			'fields' => '',
			'order' => ''
		),
 ...
 */
	public $hasAndBelongsToMany = array(
		'Vereador' => array(
			'className' => 'Vereador',
			'joinTable' => 'indicacoes_vereadores',
			'foreignKey' => 'indicacao_id',
			'associationForeignKey' => 'vereador_id',
			'unique' => 'keepExisting',
			'conditions' => '',
			'fields' => '',
			'order' => '',
