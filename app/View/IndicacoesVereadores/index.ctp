		...
		<table class="table table-condensed table-hover table-striped table-admin">
			<thead>
				<tr>
					...
					<th>
						<?php echo $this->Paginator->sort('vereador_id'); ?>
					</th>
					<th>
			...
			<tbody>
				<?php if (!empty($indicacoesVereadores)): ?>
					<?php foreach ($indicacoesVereadores as $indicacoesVereador): ?>						
						<tr>
							<td>
							...
							<td>
								<?php
									echo $this->Html->link(
										$indicacoesVereador['Vereador']['id'],
										array(
							...
							<td>
								<?php
									echo $this->Html->link(
										$indicacoesVereador['Indicacao']['name'],
										array(
											'controller' => 'indicacoes',
											'action' => 'view',
											$indicacoesVereador['Indicacao']['id']
										));
							...
							<td class="text-center" style="width:90px;">
								<?php
									echo $this->Html->link(
										...
										array(
											'action' => 'edit',
											$indicacoesVereador['IndicacoesVereador']['id']),
										array(
