	...
	<div class="table-responsive clearfix">
		<table class="table table-condensed table-hover table-striped table-admin">
			<thead>
				<tr>
					<th>
						<?php echo $this->Paginator->sort('id_proposta'); ?>
					</th>
					<th>
						<?php echo $this->Paginator->sort('id_projeto'); ?>
					</th>
					<th></th>
				</tr>
			</thead>
			<tbody>
				<?php if (!empty($propostaProjetos)): ?>
					<?php foreach ($propostaProjetos as $propostaProjeto): ?>						
						<tr>
							<td>
							...
							<td class="text-center" style="width:90px;">
								<?php
									echo $this->Html->link(
										...
										array(
											'action' => 'edit',
											$propostaProjeto['PropostaProjeto']['id_proposta']),
										array(
